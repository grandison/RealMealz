...
class Unit < Numeric
  ...
  '<cup>'=> [ ['cup', 'cups', 'cu', 'c'], 0.000236588238, :volume, %w{<meter> <meter> <meter>}],
  '<teaspoon>'=> [%w{teaspoon tsp teaspoons}, 4.92892161e-6, :volume, %w{<meter> <meter> <meter>}],
  '<tablespoon>'=> [%w{tablespoon tbs tbsp tbsps tablespoons}, 1.47867648e-5, :volume, %w{<meter> <meter> <meter>}],
  '<fluid-ounce>'=> [%w{ounce oz fluid-ounce floz ounces}, 2.95735297e-5, :volume, %w{<meter> <meter> <meter>}],
  ...
  '<pint>'=> [%w{pint pints pt}, 0.000473176475, :volume, %w{<meter> <meter> <meter>}],
